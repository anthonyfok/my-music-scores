% 天皇后喜樂（傳統粵語誦唱版）
% A traditional Cantonese chant setting of Regina Cæli
%
% Special thanks to Deacon Francis Lau 劉贊願 for providing the music and words.
%
% Typeset by Anthony Fok <anthony@anthonyfok.org> <anthony.fok@mhocp.ca>
% between 2026-02-22 to 2026-12-24 in Edmonton, Alberta, Canada

\version "2.24"
\include "../noh.ily"
\include "../jianpu10a-dash.ly"
